...
module CalendarHelper
  ...
  def calendar(options = {}, &block)
    ...
    cal << %(<thead><tr class="calendar-title"><th colspan="7">#{Date::MONTHNAMES[options[:month]]} #{options[:year]}</th></tr>)
    ...
    cal << "</tr></thead><tbody><tr class='calendar-week'>"
